    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-cover bg-center bg-gray-100">
          {/* You can replace this with your actual pathology image */}
      <Image
          src={image}
            alt="Pathology Lab"
            layout="fill"
        ...
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-200/50 via-blue-400/10 to-blue-400/20"></div>
        ...
        <div className={`relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white transition-all duration-1000 ${hasLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="max-w-4xl mx-auto">
            ...
            <p className={`text-lg sm:text-xl md:text-2xl mb-8 text-white max-w-3xl mx-auto transition-all duration-1000 delay-300 ${hasLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <div className={`flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-500 ${hasLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
           <Link href="/diagnostic-services">
           
              <Button size="lg" className="bg-blue text-blue-600 hover:bg-blue-50 font-semibold px-8 py-4 text-lg transform hover:scale-105 transition-all duration-200">
                Book Test Now
              </Button>
           </Link>
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-blue-600 font-semibold px-8 py-4 text-lg transform hover:scale-105 transition-all duration-200">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center text-white">
                    <div className="bg-white/20 backdrop-blur-sm rounded-full p-6 mb-4 mx-auto w-fit">
                      <Microscope className="h-16 w-16 mx-auto text-white" />
                    </div>
                    <p className="text-xl font-semibold mb-2">Modern Laboratory</p>
                    <p className="text-sm opacity-90">State-of-the-art diagnostic equipment</p>
                  </div>
                </div>
                </div>
            </div>
